 ...
 */
 ...
 function subnavToggles() {
    let expandToggles = document.querySelectorAll('.site-nav__expand-toggle');
    ...
    expandToggles.forEach((thisToggle) => {
        ...
        thisToggle.addEventListener('click', () => {
            if (isThisSubNavOpen == false) {
                thisToggle.nextElementSibling.classList.add("site-nav__sub-nav--open");
                thisToggle.setAttribute('aria-expanded', 'true');
                isThisSubNavOpen = true;
            } else {
                thisToggle.nextElementSibling.classList.remove("site-nav__sub-nav--open");
